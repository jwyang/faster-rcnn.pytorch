...
class roibatchLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.training:
            ...
            # NOTE! need to
            # 1: cope with the case where a group cover both conditions. (done)
            # 2: consider the situation for the tail samples. (no worry)
            # 3: implement a parallel data loader. (no worry)
            # get the index range
            ...
            if self._roidb[index_ratio]['need_crop']:
                if ratio < 1:
                    ...
                    # we need to crop the data_height
                    ...
                    # this means that data_width >> data_height
                    # we need to crop the data_width
